"""
Django settings for testing_13 project.
...
WSGI_APPLICATION = 'testing_13.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing_13 API",
    "DESCRIPTION": "API documentation for testing_13 App",
    "VERSION": "v1",
}
